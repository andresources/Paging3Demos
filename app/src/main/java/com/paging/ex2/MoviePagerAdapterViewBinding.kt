...
class MoviePagerAdapterViewBinding: PagingDataAdapter<Movie, MoviePagerAdapterViewBinding.MovieViewHolder>(MovieComparator) {

    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        val movie = getItem(position)!!
        Log.i("hary", "$position")
        holder.view.name.text = "Title : ${movie.original_title}"
